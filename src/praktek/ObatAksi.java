...
public class ObatAksi {
    public static void main (String[] args) {
        ...
        cair.Behavior="Mencegah, mengobati dan menyembuhkan";
        ...
        tablet.Behavior="Mencegah, mengobati dan menyembuhkan";
        ...
        serbuk.Behavior="Mencegah, mengobati dan menyembuhkan";
